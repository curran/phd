...
Data cubes can be effectively explored and presented using interactive visualizations. The data cube model lends itself well to existing visualization theory. This makes it straightforward to match up existing visualization techniques with classes of data cubes based on their structure (e.g. the number of dimensions and measures present). In this chapter we discuss the relationship between data cubes and information visualization.
...
\TODO{ include pseudocode, data flow diagram, and explanatory text for each visualization}
\section{Bar Chart}
\begin{figure}[h]
